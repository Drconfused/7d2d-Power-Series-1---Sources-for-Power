...
:confirmed
color 0C                                                                                                         
echo	Power Series 1 - Sources of Power                
echo.
pause
echo.                                                                       
echo.
for %%I in (.) do set CurrDirName=%%~nxI
echo This will load up the localization data for the mod "Power Series 1 - Sources of Power".
echo.
...
FINDSTR /v "batterybank_ generatorbank_ solarbank_ battery_ disposable_ junk_bat solarCell_ purifiedSili --Drconfused" LocalizationTEMP.txt > "../../data/config/Localization.txt"
